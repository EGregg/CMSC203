...
public class ChildTest {
	...
	public void setUp() throws Exception {
		...
		c1 = new Child("Little Mermaid", "G", 5,19,Format.NONE);
		//Matinee (before 6 pm)
		c2 = new Child("Little Mermaid", "G", 2,12,Format.NONE);
		//Evening IMAX movie
		c3 = new Child("Frozen", "G", 3,20,Format.IMAX);
		//Matinee IMAX
		c4 = new Child("Frozen", "G", 1,13,Format.IMAX);
		//Evening 3D
		c5 = new Child("Show Dogs", "PG", 3,21,Format.THREE_D);
		//Matinee 3D
		c6 = new Child("Show Dogs", "PG", 2,14,Format.THREE_D);
	}
	...
	@Test
	public void test() {
		/* debugging to see what format is being returned
		System.out.println(c5.getFormat());
		*/
